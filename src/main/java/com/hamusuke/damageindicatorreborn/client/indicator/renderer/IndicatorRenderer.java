...
import static com.hamusuke.damageindicatorreborn.client.DamageIndicatorRebornClient.isActuallyPaused;
...
public class IndicatorRenderer {
    ...
    public IndicatorRenderer(double x, double y, double z, String text, String source, boolean crit, float distance) {
        ...
        this.currentScale = this.calculateScale(false);
    }
    ...
    public void render(MultiBufferSource.BufferSource bufferSource, Camera camera, float tickDelta) {
        ...
        if (this.textWidth == 0) {
            ...
            tickDelta = isActuallyPaused() ? 1.0F : tickDelta;
            float scale = this.calculateScale(mc.isPaused() || isActuallyPaused());
